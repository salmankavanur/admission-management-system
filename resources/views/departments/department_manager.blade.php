                      ...
                      <table class="display table" style="min-width: 845px" id="example">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="mb-0">
                              @if($item->status=='0')
                              <a href="#" data-bs-toggle="modal" data-bs-target="#statuseModal{{ $key }}" class="btn btn-danger">Pending</i></a>
                              @elseif($item->status=='1')
                              <a href="#" data-bs-toggle="modal" data-bs-target="#statuseModal{{ $key }}" class="btn btn-success">Complete</i></a>
                              @else
                              <a href="#" class="btn btn-info">Unknown</i></a>
                              @endif
                            </td>
                            <td>
                                    ...
                                    <form action="{{ route('department.update') }}" method="post" enctype="multipart/form-data">
                                      ...
                                      <div class="row">
                                        <div class="col-xl-6">
                                          ...
                                          <div class="mb-3">
                                            <label for="exampleFormControlInput3" class="form-label">Last Date</label>
                                            <input type="date" class="form-control" name="last" placeholder="last">
                                          </div>
                                          <div class="col-xl-6">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-xl-6">
                                          ...
                                          <div class="mb-3">
                                            <label for="exampleFormControlInput3" class="form-label">Interview Date</label>
                                            <input type="date" class="form-control" name="interview" placeholder="interview">
                                          </div>
                            ...
                            <div class="modal fade" id="statuseModal{{ $key }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-center">
                                <div class="modal-content">
                                  <div class="modal-header">
                                  ...
                                  <div class="modal-footer">
                                    ...
                                    <a href="{{ route('department.status_update', $item->id) }}" class="btn btn-primary">Update</a>
