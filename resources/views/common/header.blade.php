                        ...
                        <div class="dropdown header-profile2">
                            <a class="nav-link ms-0" href="javascript:void(0);" role="button"
                                ...
                                <div class="header-info2 d-flex align-items-center">
                                    ...
                                    <img src="{{ asset('dp/'.auth()->user()->dp) }}" class="ms-0" alt="">
                                    @else
                                    <img src="{{ asset('images/no-img-avatar.png') }}" alt="">
                                    @endif
                                </div>
                            </a>
                            <div class="dropdown-menu dropdown-menu-end pb-0" style="">
                                <div class="card mb-0">
                                    <div class="card-header p-3">
                                        <ul class="d-flex align-items-center">
                                            ...
                                            <li class="ms-2">
                                                ...
                                                <span>Applicant</span>
                                                @endhasexactroles
                                                @hasanyrole('Super Admin|Manager|Staff')
                                    ...
                                    <div class="card-footer text-center p-3">
                                        <a class="dropdown-item ai-icon btn btn-primary light"  href="#" data-bs-toggle="modal" data-bs-target="#logoutModal">
