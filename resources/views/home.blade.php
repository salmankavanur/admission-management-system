...
<div class="content-body">
  ...
  <div class="container-fluid">
        ...
        <div class="card-body p-4">
          <div class="media">
            ...
            <div class="media-body text-white">
              <p class="mb-1 text-white">Hello</p>
              <h3 class="text-white">
                {{ auth()->user()->name }}
              </h3>
              <p class="mb-1 text-white">Welcome to our dashboard</p>
              @hasanyrole('Student')
              @if (isset($student))
              <span>You Have Applied On:
    ...
    <div class="row">
      ...
      <div class="col-xl-12" style="width: 70%;">
        <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.4/Chart.js"></script>
        <canvas id="myChart" style="width:100%;max-width:100%;margin: 0 17%;"></canvas>
        <script>
          const xValues = ["Institutes", "Applications","Students","Admissions"];
          const yValues = [{{ $institutes }}, {{ $students }},{{ $users }}, {{ $admission_processed }}];
          const barColors = ["#FB7D5B", "#4D44B5","#26B9B1", "#FCC43E"];
          ...
          new Chart("myChart", {
            ...
            options: {
              ...
              title: {
                display: true,
                text: "Admission Management System"
              }
            }
          });
        </script>
    ...
    <div class="row">
      ...
      <div class="col-xl-12" style="width: 70%;">
        ...
        <canvas id="myChart" style="width:100%;max-width:100%;margin: 0 17%;"></canvas>
        <script>
          const xValues = ["Departments", "Applications","Students", "Admission Processed"];
          const yValues = [{{ $institutes }}, {{ $students }},{{ $users }}, {{ $admission_processed }}];
          const barColors = ["#FB7D5B", "#4D44B5","#26B9B1", "#FCC43E"];
            ...
            <div class="card">
                <div class="card-body pb-xl-4 pb-sm-3 pb-0">
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-12">
                              <div class="content-box">
                                ...
                                <div class="chart-num">
                                  ...
                                  <h2 class="font-w700 mb-0">
                                    {{-- {{ $institute->last_date ?? "--" }} --}}
                                    {{ \Carbon\Carbon::parse($students->last_date)->format('d-m-Y') ?? '--' }}
                            ...
                            <div class="col-xl-4 col-12">
                              <div class="content-box">
                                ...
                                <div class="chart-num">
                                  <p>Interview Date</p>
                                  <h2 class="font-w700 mb-0">
                                    {{ \Carbon\Carbon::parse($students->interview_date)->format('d-m-Y') ?? '--' }}
                                  </h2>
                                </div>
                              </div>
                            </div>
                            <div class="col-xl-4 col-6">
                              <div class="content-box">
                                ...
                                <div class="chart-num">
                                  ...
                                  <p>Current Admission Status</p>
                                  @if (isset($student))
                                  <h2 class="font-w700 mb-0">
                                    <span class="badge {{ $student->status == 0 ? 'badge-warning' : ($student->status == 1 ? 'badge-primary' : ($student->status == 3 ? 'badge-success' : 'badge-danger')) }}">
                                      {{ $student->status == 0 ? 'Pending' : ($student->status == 1 ? 'Processed' : ($student->status == 3 ? 'Qualified' : 'Rejected')) }}
                                    </span>
                                  </h2>
                                  @else
                                  <h2 class="font-w700 mb-0">--</h2>
                                  @endif
                                </div>
                              </div>
                            ...
                            @else
                            <form action="{{ route('users.update_department') }}" method="post" enctype="multipart/form-data">
                              @csrf
                                ...
                                <div class="col-xl-6">
                                  <div class="mb-3">
                                    ...
                                    <select class="form-control" name="department" id="department" required>
                                      @foreach ($institutes as $key => $department)
                                  ...
                                  <button type="submit" class="btn btn-primary" style="margin: 20px 0 0 0">Save</button>
            ...
            <div class="card-body pb-xl-4 pb-sm-3 pb-0">
              <div class="row">
                <div class="col-xl-4 col-12">
                  ...
                  <div class="chart-num">
                    <a href="{{ route('razorpay') }}" class="btn btn-primary">Pay Fee</a>
                ...
                <div class="col-xl-4 col-12">
                  ...
                  <div class="col-xl-4 col-12">
                    ...
                    @if ($admission_processed)
                    <div class="chart-num">
                      <a href="{{ asset('brochure/' . $admission_processed->file) }}" class="btn btn-primary" style="width: 155px;">Download
                        Prospectus</a>
